...
import { fetchUsers, setCurrentPage, setSearch, setSortParams, updateTempUsers, setSortColumn, setSearchForSort } from '../actions';
...
class UserList extends Component {
    ...
    render() {
        ...
        }else if (this.props.tempUsers.length !== 0 && this.props.searchQuery.length >= this.props.searchQueryForSort.length) {
