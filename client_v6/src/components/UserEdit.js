...
import { editUser, fetchUser, updateTempUsers, setEditWhileSort } from '../actions';
...
class UserEdit extends Component {
    ...
    onSubmit = (formValues) => {
        ...
        this.props.editUser(this.props.selectedUser._id, formValues);
        console.log("this.props.sortDirection length: " + this.props.sortDirection.length)
        if (this.props.sortDirection.length != 0) {
            this.props.setEditWhileSort("true");
        }
    };
    ...
    render() {
        ...
        return (
            <div className="UserEdit" style={{ width: '80%', marginLeft: '15%', marginRight: '15%' }}>
                <h1>Edit User:</h1>
                <form className="ui form error" initialValues={{ firstName: "female" }} onSubmit={this.props.handleSubmit(this.onSubmit)}>
...
export default connect(mapStateToProps, { editUser: editUser, fetchUser: fetchUser, setEditWhileSort: setEditWhileSort })(formEditWrapped);