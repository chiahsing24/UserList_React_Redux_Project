...
import { createUser, setEditWhileSort } from '../actions';
...
class UserCreate extends Component {
    ...
    onSubmit = (formValues) => {
        ...
        if (this.props.sortDirection.length !== 0) {
            this.props.setEditWhileSort("");
            this.props.setEditWhileSort("true");
        } else if (this.props.isEditWhileSortAns !== "") {
            this.props.setEditWhileSort("");
            this.props.setEditWhileSort("true");
        }
    };
...
export default connect(mapStateToProps, { createUser, setEditWhileSort })(formWrapped);